...
<div class="login-form-info-wrapper">
	<?php
	$info_message  = apply_filters( 'woocommerce_checkout_login_message', esc_html__( 'Returning customer?', 'estore' ) );
	$info_message .= ' <a href="#" class="showlogin">' . esc_html__( 'Click here to login', 'estore' ) . '</a>';
